...
class AttendanceCorrectionRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'break_times.*.break_start' => 'nullable|date_format:H:i|after:clock_in|before_or_equal:clock_out',
            'break_times.*.break_end' => 'nullable|date_format:H:i|after:break_times.*.break_start|before_or_equal:clock_out',
            'reason' => 'required'
        ];
    }
